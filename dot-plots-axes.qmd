...
```{r}
#| label: eval-models
# in this script, computationally intensive models are cached 
# choose whether to check the cache for during model evaluation, and load cached models automatically: eval_models <- TRUE (will rebuild models from scratch)
# or turn off model evaluation and load the existing cache manually: eval_models <- FALSE
eval_models <- FALSE
